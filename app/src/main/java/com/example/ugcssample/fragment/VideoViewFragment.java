 ...
 */
public class VideoViewFragment extends TextureView implements SurfaceTextureListener {
    //region Properties
    ...
    public VideoViewFragment(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VideoViewFragment(Context context, AttributeSet attrs, int defStyle) {
