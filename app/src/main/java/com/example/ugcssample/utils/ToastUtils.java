...
import com.example.ugcssample.UgcsSampleApplication;
...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(UgcsSampleApplication.getInstance(), "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public static void showToast(String msg) {
        Toast.makeText(UgcsSampleApplication.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }
